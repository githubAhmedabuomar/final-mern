...
const Home = () => {
  ...
  const getcount = async () => {
    try {
      const { data } = await axios.get(
        "https://mern-e-commerce-abuelmaati-e4b4bf37fe38.herokuapp/api/v1/product/getcount"
      );
  ...
  const getproductsperpage = async () => {
    try {
      ...
      const { data } = await axios.post(
        `https://mern-e-commerce-abuelmaati-e4b4bf37fe38.herokuapp/api/v1/product/productlist/${page}`
      );
      setloading(false);
      if (data) {
        setloading(false);
  ...
  const getfilteredproducts = async () => {
    try {
      const { data } = await axios.post(
        "https://mern-e-commerce-abuelmaati-e4b4bf37fe38.herokuapp/api/v1/product/getfilteredproducts",
        { checked, radio }
      );
