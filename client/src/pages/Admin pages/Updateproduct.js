  ...
  const getsingleproduct = async () => {
    try {
      const { data } = await axios.get(
        `https://mern-e-commerce-abuelmaati-e4b4bf37fe38.herokuapp/api/v1/product/getsingleproduct/${slug}`
      );
  ...
  const Updateproduct = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://mern-e-commerce-abuelmaati-e4b4bf37fe38.herokuapp/api/v1/product/updateproduct`,
        productdata,
  ...
  const deleteproduct = async (e) => {
    ...
    try {
      const { data } = await axios.delete(
        `https://mern-e-commerce-abuelmaati-e4b4bf37fe38.herokuapp/api/v1/product/deleteproduct/${id}`,
        {
          headers: { Authorization: auth?.token },
        }
      );
