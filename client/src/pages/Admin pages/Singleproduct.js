...
const Singleproduct = () => {
  ...
  const getsimilarproducts = async () => {
    {
      try {
        const { data } = await axios.get(
          `https://mern-e-commerce-abuelmaati-e4b4bf37fe38.herokuapp/api/v1/product/getsimilarproducts/${params.slug}`
        );
  ...
  const getsingleproduct = async () => {
    try {
      const { data } = await axios.get(
        `https://mern-e-commerce-abuelmaati-e4b4bf37fe38.herokuapp/api/v1/product/getsingleproduct/${params.slug}`
      );
            ...
            >
              ...
              >
                <img
                  ...
                  src={`http://localhost:8080/api/v1/product/getproductphoto/${product?._id}`}
                ></img>
              </div>
            </div>
                ...
                <div className="col col-md-4 gy-3">
                  <div className="card shadow border text-center">
                    ...
                    >
                      <div>
                        <img
                          src={`https://mern-e-commerce-abuelmaati-e4b4bf37fe38.herokuapp/api/v1/product/getproductphoto/${p._id}`}
                          style={{
                            width: "95%",
                            height: "155px",
                            marginTop: "5px",
